/// tween_get_persistent(tween)
/* 
    Returns true if the tween is persistent, false if not.
    By default a tween is not persistent. It means that it is deleted when the rooms end, to prevent memory leaks. 
...
return argument0[TLTWEEN.PERSISTENT];
