///scr_create_trail_full(sprite, index, num_steps, image_x_offset, image_y_offset, x_scale, y_scale, precision, alpha, fade, pinch_end, trail_colour, no_show_distance)
